...
defmodule BenchmarkHelpers do
  ...
  def remove_from_set_to(%{board: board, from: from, to: to, piece: {color, type}}) do
    board
...
Benchee.run(
  %{
    "starting: remove from" => fn -> BenchmarkHelpers.remove_from(starting) end,
    "starting: set to" => fn -> BenchmarkHelpers.set_to(starting) end,
    ...
    "middlegame non-capture: set to" => fn -> BenchmarkHelpers.set_to(middlegame_non_capture) end,
    ...
    "middlegame capture: set to" => fn -> BenchmarkHelpers.set_to(middlegame_capture) end,
